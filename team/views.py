...
def MainCategory_page(request, slug):
    main_category = MainCategory.objects.get(slug=slug)

    return render (
        request,
        'team/base_content.html',
        {
            'team_matching_posts': TeamMatchingPost.objects.filter(main_category=main_category),
            'main_categories': MainCategory.objects.all(),
...
def SubCategory_page(request, slug):
    ...
    return render (
        ...
        'team/base_content.html',
        {
            'team_matching_posts': TeamMatchingPost.objects.filter(sub_category=sub_category),
            'sub_categories': SubCategory.objects.all(),
